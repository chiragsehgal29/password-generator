  ...
  <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-700 text-orange-500">
    ...
    <div className="flex shadow rounded-lg overflow-hidden mb-4">
      ...
      <button
        ...
        className="bg-blue-700 text-white px-3 py-0.5 outline-none shrink-0 hidden md:block"
      >Copy</button>
    ...
    <button
      onClick={copyPasswordToClipboard}
      className="bg-blue-700 text-white px-3 py-0.5 outline-none block md:hidden mt-4 mx-auto"
    >Copy</button>
